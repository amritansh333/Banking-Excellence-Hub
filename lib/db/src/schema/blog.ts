...
export const blogPostsTable = pgTable("blog_posts", {
  ...
  authorId: integer("author_id").references(() => blogAuthorsTable.id, { onDelete: "set null" }),
  categoryId: integer("category_id").references(() => blogCategoriesTable.id, { onDelete: "set null" }),
...
export const blogRelatedPostsTable = pgTable("blog_related_posts", {
  id: serial("id").primaryKey(),
  postId: integer("post_id").notNull().references(() => blogPostsTable.id, { onDelete: "cascade" }),
  relatedPostId: integer("related_post_id").notNull().references(() => blogPostsTable.id, { onDelete: "cascade" }),
});
