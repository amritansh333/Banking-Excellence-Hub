...
import { fetchFaqs } from "@/lib/programApi";
...
const modules = [
  {
    ...
    topics: [
      "Structure of Indian Private Banking System",
      "Overview of Regulatory Authorities",
      "Types of Bank Accounts & Deposits",
      "Loans, Credit Products & NPA Management",
      "RBI Guidelines & Private Banking Regulations",
  ...
  },
  {
    ...
    topics: [
      "Retail Private Banking Sales Process",
  ...
  {
    num: "03",
    title: "Banking Operations & Regulatory Compliance",
    topics: [
      "Complete Branch Operations",
      "KYC/AML Compliance",
      "Core Private Banking Systems Overview",
  ...
  },
  {
    ...
    topics: [
      "Life Insurance Products & Planning",
  ...
  },
  {
    ...
    topics: [
      "NBFC Structure & RBI Regulations",
  ...
  },
  {
    ...
    topics: [
      "UPI, Mobile Private Banking & Internet Private Banking",
  ...
  },
  {
    ...
    topics: [
      ...
      "Preventive Controls & Best Practices",
      "Reporting & Escalation Procedures",
    ],
  },
  {
    num: "08",
    title: "Mock Interviews & Placement Preparation",
    topics: [
      "Resume Writing & LinkedIn Optimisation",
      "Group Discussion Techniques",
      "Panel Interview Simulations",
      "HR & Aptitude Test Preparation",
      "Professional Communication & Grooming",
    ],
  },
];
...
export default function Program() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section
        ref={heroRef}
        className="hero-gradient section-padding relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-gold">Excellence Program</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="text-blue-100 text-xl font-light italic"
            >
            ...
            >
              {[
                { icon: Clock, label: "Duration", val: "2 Months" },
                { icon: Users, label: "Eligibility", val: "Any Graduate" },
                { icon: Award, label: "Placement", val: "100% Rate" },
                { icon: BookOpen, label: "Modules", val: "8 Modules" },
              ].map(({ icon: Icon, label, val }) => (
                <div
                  key={label}
                  className="glass-card px-5 py-3 text-center min-w-[120px]"
                >
            ...
            >
              <a href="#apply">
                <Button
                  size="lg"
                  className="gold-gradient text-white rounded-full px-8 py-5 font-semibold hover:scale-105 transition-transform cursor-pointer"
                >
              ...
              <a href="#curriculum">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/40 text-white rounded-full px-8 py-5 bg-white/10 hover:bg-white/20 cursor-pointer"
                >
                  View Curriculum
                </Button>
              </a>
      ...
      <section ref={overviewRef} className="section-padding bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <motion.div
            ...
            variants={stagger}
            className="grid lg:grid-cols-2 gap-7 items-start"
          >
            <motion.div variants={fadeUp} className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                While most training programs teach you how to crack an
                interview, the Private Banking & Finance Excellence Program
                teaches you how to survive, thrive, and grow once you are in.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Our faculty are active and retired senior private banking
                professionals — not teachers. Every session is built on
                real-world private banking scenarios, live case studies, and
                simulated private banking environments. When you walk into your
                first day at work, you will have the confidence of someone who
                has already been there.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: "Duration", val: "2 Months Intensive" },
                  { label: "Mode", val: "Full-Time Classroom" },
                  { label: "Eligibility", val: "Any Graduate / Final Year" },
                  { label: "Batch Size", val: "Limited (30 Students)" },
                ].map(({ label, val }) => (
            ...
            <motion.div variants={fadeUp} className="space-y-4">
              ...
              {[
                "Fresh graduates aspiring to enter the private banking and finance sector",
                "Final year students wanting to be job-ready before graduation",
                "Working professionals looking to transition into private banking or NBFCs",
                "Candidates who have attempted bank exams but want an alternative entry route",
                "Anyone seeking a structured, industry-aligned pathway to a private banking career",
              ].map((item) => (
                <div
                  key={item}
                  className="flex gap-3 items-start bg-white rounded-xl p-4 border border-border shadow-sm"
                >
                  <CheckCircle
              ...
              <div className="mt-6 bg-secondary/10 rounded-2xl p-5 border border-secondary/20">
                ...
                <p className="text-sm text-foreground italic">
                  "I joined TBA with zero knowledge of private banking. Two
                  months later I was placed at Axis Bank as a Relationship
                  Manager. A year on, I was promoted."
                </p>
                <div className="mt-3 text-sm font-semibold text-primary">
                  — Rahul Mehta, Axis Bank (Batch 2023)
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-muted-foreground mt-4 max-w-xl mx-auto">
              Every module is designed by industry practitioners to reflect
              current private banking practices, regulatory requirements, and
              market realities.
            </p>
          </motion.div>
          <motion.div
              ...
              <motion.div key={num} variants={fadeUp}>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronDown
                      className={`text-muted-foreground shrink-0 transition-transform ${activeModule === i ? "rotate-180" : ""}`}
                      size={20}
                    />
                  </div>
                  {activeModule === i && (
            ...
            >
              {outcomes.map((o, i) => (
                <motion.div
                  key={i}
                  variants={fadeUp}
                  className="flex items-start gap-3 bg-primary/5 rounded-2xl p-5 border border-primary/10"
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 text-white">
            <div className="md:col-span-1">
              ...
              <p className="text-blue-100 mt-4 leading-relaxed text-sm">
                Our placement cell works tirelessly to connect students with the
                right opportunity at the right organisation.
              </p>
            </div>
            <div className="md:col-span-2 grid sm:grid-cols-2 gap-4">
              {[
                "Resume & LinkedIn Profile Review",
                "Mock Interview Rounds (3+)",
                "Group Discussion Practice",
                "Placement Drives with 20+ Partners",
                "Personal Referrals from Faculty",
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((faq, i) => (
              ...
              >
                <AccordionTrigger className="font-semibold text-primary text-left py-5 hover:no-underline hover:text-secondary transition-colors">
                  {faq.question}
                </AccordionTrigger>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 max-w-2xl">
          <motion.div
            initial="hidden"
            animate={applyInView ? "visible" : "hidden"}
            variants={fadeUp}
          ...
          >
            ...
            <p className="text-muted-foreground mt-3">
              Fill in your details and our admissions team will reach out within
              24 hours.
            </p>
          </motion.div>
          <motion.div
