...
const placementProcess = [
  {
    ...
    desc: "Expert review and professional polish of your resume and LinkedIn profile by our placement team.",
  },
  {
    step: "02",
    title: "Mock Interviews",
    desc: "3+ rounds of mock interviews with industry panellists covering HR, technical, and aptitude rounds.",
  },
  {
    step: "03",
    title: "GD Sessions",
    desc: "Group Discussion rounds on current private banking topics to sharpen communication and analytical skills.",
  },
  {
    step: "04",
    title: "Placement Drives",
    desc: "Regular drives with our 20+ partner organisations across private banking, NBFC, and insurance sectors.",
  },
  {
    step: "05",
    title: "Offer & Joining",
    desc: "Support through offer negotiation, background verification, and joining formalities.",
  },
  {
    step: "06",
    title: "Post-Placement Support",
    desc: "Ongoing career guidance and mentorship even after placement to ensure long-term growth.",
  },
];
...
export default function Placements() {
  useEffect(() => {
    document.title = "Placements — The Bankers Academy LLP";
  }, []);
      ...
      <section className="hero-gradient section-padding relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 text-center text-white relative z-10">
          ...
          >
            ...
            >
              20+ hiring organizations. 1000+ students placed. Careers that last
              a lifetime.
            </motion.p>
          </motion.div>
        </div>
          ...
          >
            {placementProcess.map(({ step, title, desc }) => (
              <motion.div
                key={step}
                variants={fadeUp}
                className="bg-white rounded-3xl p-6 border border-border shadow-sm hover-lift"
              >
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <p className="text-muted-foreground mt-4 max-w-xl mx-auto">
                We have built deep, trusted relationships with leading private
                banks, NBFCs, and insurance companies across India.
              </p>
            </motion.div>
            <motion.div
              initial="hidden"
            ...
            >
              {hiringPartners.map((partner) => (
                <motion.div
                  key={partner}
                  variants={fadeUp}
                  className="flex items-center gap-2 px-4 py-2.5 bg-white border border-border rounded-full shadow-sm hover:border-secondary/40 hover:shadow-md transition-all"
                >
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-2xl text-center">
          <div className="hero-gradient rounded-3xl p-12 text-white">
            ...
            <p className="text-blue-100 mb-8">
              Join 1000+ alumni building successful careers in private banking
              and finance across India.
            </p>
            <Link href="/admission">
              <Button
                size="lg"
                className="gold-gradient text-white rounded-full px-10 py-5 font-semibold hover:scale-105 transition-transform cursor-pointer"
              >
