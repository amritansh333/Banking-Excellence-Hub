...
const galleryItems = [
  {
    ...
    category: "Campus",
    title: "Training Hall",
    desc: "Our state-of-the-art training facility",
    color: "bg-blue-100",
  },
  {
    id: 2,
    category: "Training",
    title: "Private Banking Workshop",
    desc: "Hands-on credit analysis session",
    color: "bg-amber-100",
  },
  {
    id: 3,
    ...
    desc: "Campus drive with HDFC Bank",
    color: "bg-green-100",
  },
  {
    id: 4,
    category: "Workshops",
    title: "GD Round",
    desc: "Group discussion practice session",
    color: "bg-purple-100",
  },
  {
    id: 5,
    ...
    desc: "2023 batch graduation ceremony",
    color: "bg-rose-100",
  },
  {
    id: 6,
    ...
    desc: "Private Banking and finance resource library",
    color: "bg-cyan-100",
  },
  {
    id: 7,
    category: "Training",
    title: "Mock Bank Setup",
    desc: "Simulated bank branch environment",
    color: "bg-orange-100",
  },
  {
    id: 8,
    category: "Placements",
    title: "Axis Bank Drive",
    desc: "40+ students placed in one drive",
    color: "bg-teal-100",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    category: "Campus",
    title: "Computer Lab",
    desc: "Core private banking system training lab",
    color: "bg-yellow-100",
  },
  {
    id: 11,
    ...
    desc: "IRDAI regulations session",
    color: "bg-pink-100",
  },
  {
    id: 12,
    category: "Certificates",
    title: "Batch 2022 Ceremony",
    desc: "100% placement batch celebration",
    color: "bg-indigo-100",
  },
  {
    id: 13,
    ...
    desc: "Digital private banking and UPI masterclass",
    color: "bg-emerald-100",
  },
  {
    id: 14,
    category: "Placements",
    title: "Bajaj Finance Drive",
    desc: "NBFC sector placement event",
    color: "bg-red-100",
  },
  {
    id: 15,
    category: "Campus",
    title: "Faculty Room",
    desc: "Where private banking professionals mentor students",
    color: "bg-sky-100",
  },
  {
    id: 16,
    ...
    desc: "Live customer acquisition simulation",
    color: "bg-lime-100",
  },
];
...
export default function Gallery() {
  useEffect(() => {
    document.title = "Gallery — The Bankers Academy LLP";
  }, []);
      ...
      <section className="hero-gradient section-padding relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 text-center text-white relative z-10">
          ...
          >
            ...
            >
              A glimpse into the world that is shaping India's next generation
              of private banking professionals.
            </motion.p>
          </motion.div>
        </div>
          ...
          >
            ...
            >
              <div className="text-center p-8">
                ...
                <span className="mt-3 inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-sm">
