...
const contactInfo = [
  {
    ...
    title: "Our Office",
    details: [
      "First Floor Dev Residency,",
      "Plot No.803, P Block, Kakadeo,",
      "Kanpur, 208025",
    ],
  },
  { icon: Phone, title: "Call Us", details: ["+91-6306286395"] },
  {
    icon: Mail,
    title: "Email Us",
    details: ["admissions@thebankersacademy.org"],
  },
  {
    icon: Clock,
    title: "Working Hours",
...
export default function Contact() {
  useEffect(() => {
    document.title = "Contact Us — The Bankers Academy LLP";
  }, []);
      ...
      <section className="hero-gradient section-padding relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 text-center text-white relative z-10">
          ...
          >
            ...
            >
              Have questions about our program or admissions? Our team is ready
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <p className="text-muted-foreground mt-3 leading-relaxed">
                Whether you have questions about admission, curriculum, fees, or
                placements — our counsellors are here to guide you through every
                step.
              </p>
            </motion.div>
            ...
            <motion.div variants={stagger} className="space-y-4">
              {contactInfo.map(({ icon: Icon, title, details }) => (
                <motion.div
                  key={title}
                  variants={fadeUp}
                  className="flex gap-4 bg-white rounded-2xl p-5 border border-border shadow-sm hover:border-secondary/30 transition-colors"
                >
            ...
            <motion.div
              variants={fadeUp}
              className="rounded-2xl overflow-hidden border border-border shadow-sm h-52 bg-primary/10 flex items-center justify-center relative"
            >
