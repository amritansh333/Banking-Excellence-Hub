    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <div
                  className="text-[#C89B3C] text-xs font-semibold mt-1"
            ...
            <p className="text-gray-300 text-sm leading-relaxed mt-2">
              A prestigious institute of private banking excellence preparing
              students to survive, thrive, and grow in the Private Banking,
              Finance, Insurance, and NBFC sectors.
            </p>
          ...
          <div>
            <h3
              className="text-base font-bold mb-6 text-white relative inline-block tracking-wide uppercase"
              style={{
        ...
        <div className="border-t border-white/10 pt-8 mt-8 space-y-3">
          <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} The Bankers Academy LLP. All
              rights reserved.
            </p>
          ...
          >
            ...
            <a
              ...
              className="text-[#C89B3C] hover:text-[#d4aa50] transition-colors font-medium"
            >
